...
interface ScreenPermissionRegistrationProps {
  onNavigate?: (page: PageType) => void;
}

const ScreenPermissionRegistration: React.FC<ScreenPermissionRegistrationProps> = ({ onNavigate }) => {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "linear-gradient(to bottom right, #F8F9FA 0%, #E8EAF6 50%, #F3E5F5 100%)", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <Sidebar currentPage="screen-permission" onNavigate={onNavigate} />
      <Box sx={{ flex: 1, p: 3 }}>
        {/* ページタイトルと保存ボタン */}
            ...
            <Table size="small">
              <TableHead>
                <TableRow sx={{ bgcolor: '#E3F2FD' }}>
                  <TableCell sx={{ fontWeight: 600, fontSize: '0.875rem', color: '#1D1D1F' }}>
                    ユーザー名
                  </TableCell>
                  <TableCell sx={{ fontWeight: 600, fontSize: '0.875rem', color: '#1D1D1F', width: 200 }}>
                    権限テンプレート
                  </TableCell>
                  <TableCell sx={{ fontWeight: 600, fontSize: '0.875rem', color: '#1D1D1F' }}>
                    詳細
