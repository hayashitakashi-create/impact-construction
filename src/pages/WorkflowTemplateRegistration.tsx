...
const WorkflowTemplateRegistration: React.FC = () => {
          ...
          <Table size="small">
            <TableHead>
              <TableRow sx={{ bgcolor: '#9E9E9E' }}>
                <TableCell sx={{ fontWeight: 600, width: 60, fontSize: '0.75rem', color: '#FFFFFF' }}>並替</TableCell>
                <TableCell sx={{ fontWeight: 600, width: 60, fontSize: '0.75rem', color: '#FFFFFF' }}>修正</TableCell>
                <TableCell sx={{ fontWeight: 600, width: 60, fontSize: '0.75rem', color: '#FFFFFF' }}>削除</TableCell>
                <TableCell sx={{ fontWeight: 600, width: 150, fontSize: '0.75rem', color: '#FFFFFF' }}>申請対象</TableCell>
                <TableCell sx={{ fontWeight: 600, fontSize: '0.75rem', color: '#FFFFFF' }}>テンプレート名</TableCell>
                <TableCell sx={{ fontWeight: 600, fontSize: '0.75rem', color: '#FFFFFF' }}>承認者一覧</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
